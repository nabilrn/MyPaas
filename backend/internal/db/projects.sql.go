...
RETURNING id, user_id, name, repo_url, branch, subdomain, deploy_mode, main_service, app_port, webhook_secret, allocated_port, memory_limit_mb, cpu_limit, status, active_deployment_id, created_at, updated_at, deleted_at, resource_profile, compose_file_path, compose_override_paths, compose_profiles, compose_workdir, service_resources, static_frontend_path, base_directory, image_ref, additional_routes
`
...
SELECT id, user_id, name, repo_url, branch, subdomain, deploy_mode, main_service, app_port, webhook_secret, allocated_port, memory_limit_mb, cpu_limit, status, active_deployment_id, created_at, updated_at, deleted_at, resource_profile, compose_file_path, compose_override_paths, compose_profiles, compose_workdir, service_resources, static_frontend_path, base_directory, image_ref, additional_routes
FROM projects
