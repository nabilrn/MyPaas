...
- Stable backup/restore CLI help, plan output, and restore follow-up wording now describe the current disaster-recovery contract without obsolete beta-readiness terminology; historical qualification records remain unchanged.
