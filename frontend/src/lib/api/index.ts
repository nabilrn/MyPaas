import type { Project, Deployment, EnvVar, MetricsSnapshot, QuotaUsage, User } from '$types';
...
export const api = {
	...
	logs: {
		list: (projectId: string, tail = 500): Promise<{ lines: string[] }> => request(`/projects/${projectId}/logs?tail=${tail}`)
	},
