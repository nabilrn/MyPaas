			...
			{#if revealed}
				<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
					<path
						...
						d="M3 3l18 18M10.6 10.6A2 2 0 0013.4 13.4M9.9 4.2A10.8 10.8 0 0112 4c4.5 0 8.3 2.9 9.5 7a10.9 10.9 0 01-3 4.7M6.1 6.1A10.8 10.8 0 002.5 11c1.2 4.1 5 7 9.5 7 1.3 0 2.5-.2 3.6-.7"
					/>
				</svg>
			{:else}
				<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
